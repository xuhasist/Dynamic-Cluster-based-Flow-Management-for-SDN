...
function networkThroughput = byFlowSaturation(g, linkBwdUnit, linkThputStruct, ...
    ...
    while begin_time ~= end_time
        ...
        % flows are active at the one minute
        ...
        if any(rows)
            ...
            for i = 1:length(flow_index)
                ...
                % calculate average flow throughput in each link along the path
                for j = 1:length(edge)-1
                    ...
                    % record bottleneck link throughput
            ...
            % network throughput = total throughput of all flows
