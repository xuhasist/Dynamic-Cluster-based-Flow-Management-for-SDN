function drawClusterSize(x_axis, y_axis_clusterSize, x_label)
    x = 1:length(x_axis);
    y = y_axis_clusterSize;
    ...
    print(h_figure, '-depsc', 'dynamic_clusterSize_fatTree.eps');
end
