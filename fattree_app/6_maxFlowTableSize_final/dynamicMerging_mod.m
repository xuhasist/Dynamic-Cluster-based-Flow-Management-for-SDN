function [flowTraceTable, doHierarchyCount, initialClusterTable, mergedFlow] = dynamicMerging_mod(tableThreshold, swWithTooManyFlowEntry, ...
    ...
    for i = 1:length(swWithTooManyFlowEntry)
        ...
        while groupNumber >= tableThreshold || doMerging == -1
            ...
            mergedFlow = [mergedFlow, find(flow_rows)'];
        end
    end
